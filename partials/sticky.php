            ...
            <div class="header__user">
                <div class="user-avatar">
                    ...
                    <?php if (empty($_SESSION['id'])) { ?>
                        <div class="avatar-indicator guest"></div>
                    <?php } else { ?>
                        <div class="avatar-indicator logged-in"></div>
                    <?php } ?>
                </div>
                <ul class="user__info">
                    <li>
                        <?php if (empty($_SESSION['id'])) { ?>
                            <div class="auth-links">
                                <a href="./signup.php" class="auth-link"><i class="fas fa-user-plus"></i> Đăng Ký</a>
                                <span class="auth-divider"></span>
                                <a href="login.php" class="auth-link"><i class="fas fa-sign-in-alt"></i> Đăng Nhập</a>
                            </div>
                        <?php } else { ?>
                            <div class="user-welcome">
                                <i class="fas fa-user-circle"></i>
                                <span>Hi! bạn <?php echo $_SESSION['name'] ?></span>
                            </div>
                    ...
                    <?php if (!empty($_SESSION['id'])) { ?>
                        <li>
                            <a href="./info_order.php"><i class="fas fa-clipboard-list"></i> Thông tin đơn hàng</a>
                        </li>
                    <?php } ?>
                </ul>
            </div>
